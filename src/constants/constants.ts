...
export const GENERATE_MODELS: GenerateModel[] = [
  {
    ...
    backgroundColor: 'bg-white dark:bg-gray-800/50',
  ...
  },
  {
    ...
    backgroundColor: 'bg-white dark:bg-amber-900/20',
    iconWrapper: 'bg-amber-100 dark:bg-amber-800/50',
    icon: Video,
  ...
  },
  {
    ...
    backgroundColor: 'bg-white dark:bg-cyan-900/20',
    iconWrapper: 'bg-cyan-100 dark:bg-cyan-800/50',
    icon: Zap,
  ...
  },
  {
    ...
    backgroundColor: 'bg-white dark:bg-purple-900/20',
    iconWrapper: 'bg-purple-100 dark:bg-purple-800/50',
    icon: Wand2,
  ...
  },
  {
    ...
    backgroundColor: 'bg-white dark:bg-green-900/20',
    iconWrapper: 'bg-green-100 dark:bg-green-800/50',
    icon: Play,
  ...
  },
  {
    ...
    backgroundColor: 'bg-white dark:bg-slate-800/50',
    iconWrapper: 'bg-slate-100 dark:bg-slate-700',
    icon: Layers,
  ...
  },
  {
    ...
    backgroundColor: 'bg-white dark:bg-rose-900/20',
    iconWrapper: 'bg-rose-100 dark:bg-rose-800/50',
    icon: BookOpen,
